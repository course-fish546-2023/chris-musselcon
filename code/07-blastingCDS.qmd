...
-out /home/shared/8TB_HDD_02/cnmntgna/output/cds_blastx.tab \
-evalue 1E-20 \
-num_threads 20 \
-max_target_seqs 1 \
-outfmt 6
...
head /home/shared/8TB_HDD_02/cnmntgna/output/cds_blastx.tab
mv /home/shared/8TB_HDD_02/cnmntgna/output/cds_blastx.tab /home/shared/8TB_HDD_02/cnmntgna/GitHub/chris-musselcon/data
```
...
```
#don't use chunk 112-116
```{bash}

curl -O -H Accept: text/plain; format=tab "https://gannet.fish.washington.edu/seashell/snaps/uniprot_table_r2023_01.tab"
